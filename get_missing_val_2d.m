function field=get_missing_val_2d(lon,lat,field,missvalue,ro,default)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
%    ro       : oa decorrelation scale (e.g. 0)
%    default  : default value given if there is only missing data (e.g. NaN)
%
%  output:
